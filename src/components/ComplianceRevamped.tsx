      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        <section className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
            <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Compliance Lines</p>
            <p className="mt-2 text-3xl font-bold text-foreground">{isLoading ? '...' : summary.total}</p>
          </div>
          <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
            <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Healthy</p>
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
            ...
            <p className="mt-2 text-3xl font-bold text-foreground">{isLoading ? '...' : summary.pending}</p>
          </div>
        </section>
        ...
        <section className="mt-6 grid gap-6 xl:grid-cols-[1.35fr,1fr]">
          <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
            <header className="flex items-center justify-between">
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Service Compliance</p>
                <h2 className="text-xl font-semibold text-foreground">Client Service Compliance Matrix</h2>
              </div>
            ...
            <div className="mt-4" style={{ overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {isLoading ? (
                    <tr>
                      <td colSpan={7} style={{ padding: '1rem', color: 'var(--color-text-muted)' }}>
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-sm">
            <header className="flex items-center justify-between">
              <div>
                ...
                <h2 className="text-xl font-semibold text-foreground">Compliance Notifications</h2>
              </div>
