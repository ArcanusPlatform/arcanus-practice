      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="mb-8 grid gap-4 md:grid-cols-4">
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
            ...
            <p className="mt-2 text-3xl font-bold text-foreground">{directoryContacts.length}</p>
          </div>
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
            ...
            <p className="mt-2 text-3xl font-bold text-foreground">{agentContacts.length}</p>
          </div>
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
            ...
            <p className="mt-2 text-3xl font-bold text-foreground">{hmrcContacts.length}</p>
          </div>
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex flex-1 items-center gap-3 rounded-xl border border-border px-3 py-2">
              ...
              <input
                ...
                className="h-8 w-full border-0 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none"
              />
            </div>
        ...
        <div className="rounded-2xl border border-border bg-card shadow-sm">
          <div className="overflow-x-auto">
            {isLoading ? (
              <p className="py-10 text-center text-sm text-muted-foreground">Loading contacts...</p>
                      ...
                      <td className="px-6 py-4">
                        {contact.phone ? (
                          <a
                            ...
                            className="flex items-center gap-1.5 text-sm text-foreground hover:text-foreground"
                            onClick={(e) => e.stopPropagation()}
                          >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 rounded-lg border border-border bg-card px-3 py-1.5 text-sm font-semibold text-foreground shadow-sm transition hover:bg-muted"
                          >
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 rounded-lg border border-rose-200 bg-card px-3 py-1.5 text-sm font-semibold text-rose-600 shadow-sm transition hover:bg-rose-50"
                          >
