          ...
          <div>
            ...
            <input
              ...
              style={{
                ...
                padding: '0.65rem',
                borderRadius: '10px',
                border: errors.name ? '1px solid #f87171' : '1px solid var(--color-border)',
              }}
            />
            {errors.name && (
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  padding: '0.65rem',
                  borderRadius: '10px',
                  border: errors.email ? '1px solid #f87171' : '1px solid var(--color-border)',
                }}
              />
              {errors.email && (
                <p style={{ color: '#dc2626', fontSize: '0.75rem', marginTop: '0.25rem' }}>
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...
                  padding: '0.65rem',
                  borderRadius: '10px',
                  border: errors.phone ? '1px solid #f87171' : '1px solid var(--color-border)',
                }}
              />
              {errors.phone && (
                <p style={{ color: '#dc2626', fontSize: '0.75rem', marginTop: '0.25rem' }}>
          ...
          <div>
            ...
            <input
              ...
              style={{
                ...
                padding: '0.65rem',
                borderRadius: '10px',
                border: errors.address ? '1px solid #f87171' : '1px solid var(--color-border)',
              }}
            />
            {errors.address && (
              <p style={{ color: '#dc2626', fontSize: '0.75rem', marginTop: '0.25rem' }}>
