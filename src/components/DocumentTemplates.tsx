      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-lg border border-border bg-card px-3 py-2 text-sm font-medium text-foreground shadow-sm focus:border-purple-900 focus:outline-none"
            >
        ...
        <div className="mb-8 grid gap-4 md:grid-cols-4">
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
            <FileText className="mb-3 h-8 w-8 text-foreground" />
          ...
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
            ...
            <p className="mt-2 text-3xl font-bold text-foreground">{PRACTICE_TEMPLATE_SECTIONS.length}</p>
          </div>
          <div className="rounded-2xl border border-border bg-card p-5 shadow-sm">
            <FileEdit className="mb-3 h-8 w-8 text-primary" />
            <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">
              Setup Letters
            </p>
        ...
        <div className="space-y-6">
          {isLoading ? (
            ...
            <div className="rounded-2xl border border-border bg-card p-10 text-center shadow-sm">
              ...
              <p className="text-muted-foreground">No letter templates match your search.</p>
            </div>
          ) : (
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="flex w-full items-center justify-between p-6 text-left transition hover:bg-muted"
                  >
                      ...
                      <table className="w-full">
                        ...
                        <tbody className="divide-y divide-border">
                          {sectionTemplates.map((template) => (
                            <tr key={template.filename} className="hover:bg-muted">
                              ...
                              <td className="px-6 py-4 text-center">
                                <span className="inline-flex items-center gap-1 text-sm font-semibold text-foreground">
                                  ...
                                  <span className="text-xs font-normal text-muted-foreground">fields</span>
                                </span>
                              </td>
                              <td className="px-6 py-4">
                                <div className="flex items-center justify-end gap-2">
                                  <button
                                    ...
                                    className="inline-flex items-center gap-1.5 rounded-lg border border-border bg-card px-3 py-1.5 text-sm font-semibold text-foreground shadow-sm transition hover:bg-muted disabled:opacity-50"
                                  >
