      ...
      >
        ...
        <form onSubmit={handleSubmit} style={{ flex: 1, overflow: 'auto', padding: '2rem' }}>
          {step === 1 && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  <button
                    ...
                    style={{
                      padding: '1rem',
                      border: `2px solid ${formData.clientType === 'business' ? 'var(--primary-purple)' : 'var(--color-border)'}`,
                      borderRadius: '8px',
                      background: formData.clientType === 'business' ? 'rgba(124, 58, 237, 0.1)' : '#fff',
                      cursor: 'pointer',
                      display: 'flex',
                      flexDirection: 'column',
                      alignItems: 'center',
                  ...
                  >
                    <Building2 size={24} style={{ color: formData.clientType === 'business' ? 'var(--primary-purple)' : 'var(--color-text-muted)' }} />
                    <span style={{ fontWeight: 600 }}>Business / Company</span>
                    <span style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)' }}>Ltd, PLC, LLP, etc.</span>
                  </button>
                  ...
                  <button
                    ...
                    style={{
                      padding: '1rem',
                      border: `2px solid ${formData.clientType === 'individual' ? 'var(--primary-purple)' : 'var(--color-border)'}`,
                      borderRadius: '8px',
                      background: formData.clientType === 'individual' ? 'rgba(124, 58, 237, 0.1)' : '#fff',
                      cursor: 'pointer',
                      display: 'flex',
                      flexDirection: 'column',
                      alignItems: 'center',
                  ...
                  >
                    <User size={24} style={{ color: formData.clientType === 'individual' ? 'var(--primary-purple)' : 'var(--color-text-muted)' }} />
                    <span style={{ fontWeight: 600 }}>Individual</span>
                    <span style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)' }}>Sole trader, person</span>
                  </button>
                </div>
              </div>
              ...
              {formData.clientType === 'business' && (
                <div>
                  <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <Building2 size={20} style={{ color: 'var(--primary-purple)' }} />
                    Company Information
                  </h3>
              ...
              {formData.clientType === 'individual' && (
                <div>
                  <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <User size={20} style={{ color: 'var(--primary-purple)' }} />
          ...
          {step === 2 && (
            <div>
              <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <MapPin size={20} style={{ color: 'var(--primary-purple)' }} />
                Business Address
              </h3>
          ...
          {step === 3 && (
            <div>
              <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <FileText size={20} style={{ color: 'var(--primary-purple)' }} />
          ...
          {step === 4 && (
            <div>
              <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <CreditCard size={20} style={{ color: 'var(--primary-purple)' }} />
