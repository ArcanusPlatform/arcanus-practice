      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="grid gap-4 md:grid-cols-3" style={{ marginBottom: '1.5rem' }}>
          <div className="card" style={{ padding: '1rem' }}>
            <p style={{ fontSize: '0.8rem', textTransform: 'uppercase', color: 'var(--color-text-muted)' }}>
              Results Shown
            </p>
        ...
        <div style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '12px' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            ...
            <tbody>
              {isLoading ? (
                ...
                <tr>
                  <td colSpan={7} style={{ padding: '2.5rem', textAlign: 'center' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', alignItems: 'center' }}>
                      <FileSearch size={42} style={{ color: 'var(--color-text-muted)', opacity: 0.7 }} />
                ...
                results.map((company) => (
                  <tr key={company.companyNumber} style={{ borderTop: '1px solid var(--color-border)' }}>
                    ...
                    <td style={{ padding: '0.75rem' }}>
                      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.4rem' }}>
                        <MapPin size={14} style={{ marginTop: '0.2rem', color: 'var(--color-text-muted)' }} />
