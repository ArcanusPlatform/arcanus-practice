...
import { 
  ...
  RefreshCw, Edit2, Send, Info, Layers, Plus, Palette, Sun, Moon
} from 'lucide-react';
...
export default function SettingsRedesigned() {
  ...
  const roleTone = (roleCode: string) => {
    if (roleCode === 'admin') return 'bg-primary/10 text-primary';
  ...
  return (
    <UniversalPageLayout>
            ...
            <div className="bg-card rounded-2xl border border-border shadow-sm p-8">
              ...
              {activeSection === 'appearance' && (
                <div>
                  ...
                  <p className="text-muted-foreground mb-6">
                    Choose how the reusable Arcanus theme is applied across the app.
                  </p>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <span className="grid h-10 w-10 place-items-center rounded-xl bg-card text-violet-600 shadow-sm">
                          <Sun className="h-5 w-5" />
                        </span>
                        <div>
                          <p className="font-semibold text-foreground">Light content</p>
                          <p className="text-sm text-muted-foreground">Light cards and pages with the dark chrome shell.</p>
                        </div>
                      </div>
                    </button>
                    ...
                    <button
                      ...
                      className={`rounded-2xl border p-5 text-left transition ${
                        settings.themeMode === 'dark'
                          ? 'border-violet-500 bg-violet-950/70 shadow-md'
                          : 'border-border bg-card hover:bg-muted'
                      }`}
                    >
                      <div className="flex items-center gap-3">
                        <span className="grid h-10 w-10 place-items-center rounded-xl bg-slate-900 text-violet-300 shadow-sm">
                          <Moon className="h-5 w-5" />
                        </span>
                        <div>
                          <p className={`font-semibold ${settings.themeMode === 'dark' ? 'text-white' : 'text-foreground'}`}>
                            Dark theme
                          </p>
                          <p className="text-sm text-muted-foreground">
                            Matches the reusable theme style guide's dark surfaces.
                          </p>
                        </div>
                      </div>
                    </button>
                  ...
                  <div className="mt-6 rounded-xl border border-border bg-muted p-4">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      The app is using <span className="font-semibold">{settings.themeMode}</span> via the root
                      <code className="mx-1 rounded bg-background px-1.5 py-0.5 text-xs">data-theme</code>
                      attribute.
                    </p>
                  </div>
                </div>
                  ...
                  <form onSubmit={handleSaveProfile} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2.5 border border-input rounded-lg focus:ring-2 focus:ring-ring focus:border-transparent"
                          placeholder="John"
                        />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={email}
                        disabled
                        className="w-full px-4 py-2.5 border border-input rounded-lg bg-muted text-muted-foreground"
                      />
                    ...
                    <div className="flex justify-end pt-4">
                      <button
                        type="submit"
                        className="px-6 py-2.5 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-all shadow-md hover:shadow-lg"
                      >
                        Save Profile
                      </button>
                    </div>
              ...
              {activeSection === 'company' && (
                <div>
                  ...
                  <p className="text-muted-foreground mb-6">Manage your practice details and bank information used across reports, templates, and correspondence</p>
                  ...
                  <form onSubmit={handleSaveCompany} className="space-y-8">
                    ...
                    <div className="pt-6 border-t border-border">
                      <h3 className="text-lg font-semibold text-foreground mb-4">Practice Bank Details</h3>
              ...
              {activeSection === 'email' && (
                <div>
                  <h2 className="text-2xl font-bold text-foreground mb-2">Email Delivery</h2>
                  <p className="text-muted-foreground mb-6">
                  ...
                  {emailEnabled ? (
                    ...
                    <div className="mb-6 p-4 rounded-lg border border-border bg-muted flex items-center gap-3">
                  ...
                  <form onSubmit={handleSaveEmail} className="space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="md:col-span-2 flex items-center justify-between rounded-lg border border-border bg-muted px-4 py-3">
                        <div>
                          <p className="font-semibold text-foreground">Enable outbound email</p>
                          <p className="text-sm text-muted-foreground">Turn on reminders, engagement sends, and client notifications.</p>
                        </div>
                        <button
                          type="button"
                    ...
                    <div className="pt-6 border-t border-border">
                      <h3 className="text-lg font-semibold text-foreground mb-4">SMTP Connection</h3>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          <label className="block text-sm font-semibold text-foreground mb-2">
                            SMTP Host
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <input
                              ...
                              className="w-full px-4 py-2.5 pr-12 border border-input rounded-lg focus:ring-2 focus:ring-ring focus:border-transparent"
                          ...
                          {emailSmtpPasswordSet && !emailSmtpPassword && (
                            <p className="text-xs text-muted-foreground mt-1">A password is already saved. Leave blank to keep it.</p>
                          )}
                        </div>
                      </div>

                      <div className="mt-6 flex items-center justify-between rounded-lg border border-border bg-muted px-4 py-3">
                        <div>
                          <p className="font-semibold text-foreground">Use secure SMTP connection</p>
                          <p className="text-sm text-muted-foreground">Enable this for SSL/TLS ports such as 465.</p>
                        </div>
                        <button
                          type="button"
                    ...
                    <div className="pt-6 border-t border-border">
                      <h3 className="text-lg font-semibold text-foreground mb-4">Test Delivery</h3>
                      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-4 items-end">
                        ...
                        <button
                          ...
                          className="px-6 py-2.5 border border-input rounded-lg hover:bg-muted font-semibold flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                    ...
                    <div className="flex justify-end pt-4">
                      <button
                        ...
                        className="px-6 py-2.5 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-all shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                      >
              ...
              {activeSection === 'portfolios' && (
                <div>
                  <h2 className="text-2xl font-bold text-foreground mb-2">Portfolios</h2>
                  <p className="text-muted-foreground mb-6">
                  ...
                  <div className="mb-8 rounded-xl border border-border p-5">
                    <h3 className="text-lg font-semibold text-foreground mb-4">Add Portfolio</h3>
                    <form onSubmit={handleAddPortfolio} className="grid gap-4 md:grid-cols-4">
                      ...
                      <div className="md:col-span-4 flex justify-end">
                        <button
                          type="submit"
                          className="inline-flex items-center gap-2 px-4 py-2.5 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-all shadow-md hover:shadow-lg"
                        >
                    ...
                    <table className="w-full">
                      <thead className="bg-muted border-b border-border">
                        <tr>
                          ...
                          <th className="px-4 py-3 text-right text-xs font-semibold text-muted-foreground uppercase">Clients</th>
                          <th className="px-4 py-3 text-left text-xs font-semibold text-muted-foreground uppercase">Default</th>
                      ...
                      <tbody className="divide-y divide-border bg-card">
                        {portfolios.map((portfolio) => {
                          ...
                          return (
                            <tr key={portfolio.id} className="hover:bg-muted">
                              <td className="px-4 py-4 font-mono text-sm text-foreground">{portfolio.code}</td>
                              ...
                              <td className="px-4 py-4">
                                {isEditing ? (
                                  ...
                                  <span className="text-muted-foreground">{portfolio.description || '—'}</span>
                                )}
                              </td>
                              <td className="px-4 py-4 text-right font-semibold text-foreground">{linkedClients}</td>
                              <td className="px-4 py-4">
                                {portfolio.isDefault ? (
                                  ...
                                  <button
                                    ...
                                    className="px-2 py-1 text-xs font-semibold rounded-full border border-input text-foreground hover:bg-muted"
                                  >
                                    Set Default
                                  </button>
                                )}
                                  ...
                                  {isEditing ? (
                                    <>
                                      <button
                                        ...
                                        className="px-3 py-1.5 text-sm font-semibold rounded-lg bg-primary text-primary-foreground hover:bg-primary/90"
                                      >
                                        Save
                                      </button>
                                      <button
                                        onClick={cancelEditPortfolio}
                                        className="px-3 py-1.5 text-sm font-semibold rounded-lg border border-input hover:bg-muted"
                                      >
                                        Cancel
                                      </button>
                                    </>
              ...
              {activeSection === 'team' && (
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      <h2 className="text-2xl font-bold text-foreground mb-2">Team & Users</h2>
                      <p className="text-muted-foreground">Manage team members and pending invitations</p>
                    </div>
                    <button
                      onClick={() => setShowInviteForm(true)}
                      className="px-4 py-2 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-all shadow-md hover:shadow-lg flex items-center gap-2"
                    >
                  ...
                  <div className="grid gap-4 md:grid-cols-4 mb-8">
                    <div className="rounded-xl border border-border bg-muted p-4">
                      ...
                      <p className="mt-2 text-sm text-muted-foreground">Practice users with current access</p>
                    </div>
                    <div className="rounded-xl border border-border bg-muted p-4">
                    ...
                    <div className="rounded-xl border border-border bg-muted p-4">
                      <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Available Roles</p>
                      <p className="mt-2 text-3xl font-bold text-foreground">{roles.length}</p>
                      <p className="mt-2 text-sm text-muted-foreground">Admin, Manager, Staff and Read-only</p>
                    </div>
                    <div className="rounded-xl border border-border bg-muted p-4">
                      <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Admin Users</p>
                      <p className="mt-2 text-3xl font-bold text-primary">
                        {users.filter((user) => user.role === 'admin').length}
                      </p>
                      <p className="mt-2 text-sm text-muted-foreground">Users able to manage settings and team access</p>
                    </div>
                  </div>

                  {roles.length > 0 && (
                    <div className="mb-8">
                      <h3 className="text-lg font-semibold text-foreground mb-4">Role Access Matrix</h3>
                      <div className="grid gap-4 xl:grid-cols-2">
                        {availableRoles.map((role) => (
                          <div key={role.code} className="rounded-xl border border-border bg-card p-5">
                            <div className="flex items-start justify-between gap-4">
                              ...
                              <div className="text-right">
                                ...
                                <p className="mt-1 text-2xl font-bold text-foreground">{role.modules.length}</p>
                              </div>
                            </div>
                      ...
                      <table className="w-full">
                        <thead className="bg-muted border-b border-border">
                          <tr>
                            ...
                            <th className="px-4 py-3 text-left text-xs font-semibold text-muted-foreground uppercase">Access</th>
                        ...
                        <tbody className="divide-y divide-border bg-card">
                          {users.map((user) => (
                            <tr key={user.id} className="hover:bg-muted">
                              ...
                              <td className="px-4 py-4 text-muted-foreground text-sm">{formatDate(user.created_at)}</td>
                              <td className="px-4 py-4 text-muted-foreground text-sm">
                              ...
                              <td className="px-4 py-4">
                                <select
                                  ...
                                  className="rounded-lg border border-input px-3 py-2 text-sm font-medium text-foreground focus:ring-2 focus:ring-ring focus:border-transparent disabled:opacity-50"
                                  title="Change role"
                                >
                                  {availableRoles.map((role) => (
                          ...
                          return (
                            <div
                              ...
                              className={`p-4 rounded-lg border ${
                                expired ? 'border-red-200 bg-red-50' : 'border-border bg-card'
                              }`}
                            >
                              <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-2">
                                  <button
                                    ...
                                    className="px-3 py-1.5 text-sm border border-input rounded-lg hover:bg-muted flex items-center gap-2"
              ...
              {activeSection === 'hmrc' && (
                <div>
                  <h2 className="text-2xl font-bold text-foreground mb-2">HMRC API Integration</h2>
                  <p className="text-muted-foreground mb-6">Connect your HMRC API credentials to support tax and compliance integrations across the practice</p>
                  ...
                  {hmrcStatus === 'connected' ? (
                    ...
                    <div className="mb-6 p-4 rounded-lg border border-border bg-muted flex items-center gap-3">
                      <AlertCircle className="w-5 h-5 text-muted-foreground" />
                      <p className="text-foreground">Not connected. Enter your credentials below to connect.</p>
                    </div>
                  )}
                  ...
                  <form className="space-y-6">
                    <div>
                      ...
                      />
                      <p className="text-xs text-muted-foreground mt-1">Obtain from HMRC Developer Hub</p>
                    </div>
                    ...
                    <div>
                      ...
                      />
                      <p className="text-xs text-muted-foreground mt-1">Keep this secure and never share it</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">Use Sandbox for testing and Production for live HMRC integrations</p>
                    </div>
              ...
              {activeSection === 'companies-house' && (
                <div>
                  <h2 className="text-2xl font-bold text-foreground mb-2">Companies House API Integration</h2>
                  <p className="text-muted-foreground mb-6">
                  ...
                  <form onSubmit={handleSaveCompaniesHouseApiKey} className="mb-6 space-y-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button
                        ...
                        className="px-6 py-2.5 border border-input rounded-lg hover:bg-muted font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        Clear Saved Key
                      </button>
                    </div>
              ...
              {activeSection === 'gov-gateway' && (
                <div>
                  <h2 className="text-2xl font-bold text-foreground mb-2">Government Gateway</h2>
                  <p className="text-muted-foreground mb-6">Store your Government Gateway credentials for quick access to HMRC services</p>
                  ...
                  <form className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-2">🔒 Credentials are encrypted and stored securely</p>
                    </div>
      ...
      {/* Invite Modal */}
      {showInviteForm && (
        <div className="modal is-open p-4">
          <div className="bg-card rounded-2xl p-6 max-w-md w-full shadow-xl">
            ...
            <form onSubmit={handleInvite} className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">Select the access level the invited user should receive when they join.</p>
              </div>
              ...
              <div className="flex gap-3 pt-4">
                <button
                  ...
                  className="flex-1 px-4 py-2.5 border border-input rounded-lg hover:bg-muted font-semibold"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={inviting}
                  className="flex-1 px-4 py-2.5 bg-primary text-primary-foreground font-semibold rounded-lg hover:bg-primary/90 transition-all shadow-md hover:shadow-lg disabled:opacity-50"
                >
