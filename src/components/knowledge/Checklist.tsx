                  ...
                  return (
                    ...
                    >
                      {isChecked ? (
                        ...
                        <Square size={20} style={{ color: 'var(--color-text-muted)', flexShrink: 0 }} />
                      )}
                      <span
                        style={{
                          fontSize: '0.95rem',
                          textDecoration: isChecked ? 'line-through' : 'none',
                          color: isChecked ? 'var(--color-text-muted)' : 'inherit',
                        }}
                      >
                        {item}
                      </span>
      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        >
          ...
          >
            ...
            >
              <ExternalLink size={16} style={{ color: 'var(--primary-purple)' }} />
