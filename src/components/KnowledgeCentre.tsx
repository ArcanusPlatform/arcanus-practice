      ...
      <div style={{ marginTop: '2rem' }}>
        ...
        >
          ...
          >
            ...
            >
              <ExternalLink size={20} style={{ color: 'var(--primary-purple)' }} />
              <div>
            ...
            >
              ...
              <div>
                ...
                <div style={{ fontSize: '0.8rem', color: 'var(--color-text-muted)' }}>Using CDS</div>
              </div>
            </a>
          </div>
        </div>
        ...
        >
          {[
            ...
            >
              ...
              <span style={{ color: 'var(--primary-purple)', fontSize: '1.25rem' }}>→</span>
            </div>
          ))}
        </div>
      </div>
